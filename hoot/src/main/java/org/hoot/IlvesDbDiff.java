...
public class IlvesDbDiff {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        PropertiesUtil.setCategoryRedirection("site", HootMain.PROPERTIES_FILE_PREFIX);
        final String diff = PersistenceUtil.diff(HootMain.PERSISTENCE_UNIT, HootMain.PROPERTIES_FILE_PREFIX);
